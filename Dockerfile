...
LABEL MAINTAINER="Givecamp Memphis <info@givecampmemphis.org>"
...
ENV SQLALCHEMY_DATABASE_URI="postgresql://skyway_connect:verystrongpass@postgres/skyway_connect"
